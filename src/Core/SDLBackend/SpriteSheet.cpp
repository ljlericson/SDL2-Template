...
{
SpriteSheet::SpriteSheet(SDL_Renderer* renderer, const std::string& fpath, int frameW, int frameH,
                         int numFramesX, int numFramesY)
    : m_texHand(
          AssetManager::textureManager->newTexture("AnimatedTexture:" + fpath, renderer, fpath)),
      pos(0.0f), m_frameW(frameW), m_frameH(frameH), m_numFramesX(numFramesX),
...
SpriteSheet::SpriteSheet(SDL_Texture* texture, int frameW, int frameH, int numFramesX,
                         int numFramesY)
    : m_texHand(AssetManager::textureManager->newTexture("AnimatedTexture:FromSDLTexture", nullptr,
                                                         texture)),
      pos(0.0f), m_frameW(frameW), m_frameH(frameH), m_numFramesX(numFramesX),
      m_numFramesY(numFramesY)
{
