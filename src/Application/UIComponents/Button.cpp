      ...
      m_texRect(rect)
{
    ...
    m_text = Core::SDLBackend::Text(glm::vec2{m_texSrcRect.x, m_texSrcRect.y}, m_texSrcRect.w,
                                    m_texSrcRect.h, "./assets/Fonts/font.ttf",
                                    SDL_Color(255, 0, 0, 255), title);
}
...
void Button::render(const Core::SDLBackend::Renderer& renderer)
{
    ...
    m_text.getRectToSetPosManually() =
        SDL_FRect{.x = m_texRect.x + ((m_texRect.w - m_texRect.w * 0.9f) / 2.0f),
